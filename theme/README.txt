...
CCK makes the following variables available in your theme's node.tpl.php
template (and the associated node-<CONTENT_TYPE>.tpl.php suggestions) :
...
Most formatter's themes come as theme functions, but some might use templates.
